...
import newPostIcon from "../assets/images/new-post.svg";
  ...
  return (
    <>
      ...
      >
          ...
          <Box className="profile__info">
            ...
            >
              ...
              <Button
                  ...
                  startIcon={hover ? <EditOutlinedIcon />:<img src={EditIcon} alt="Edit Icon" />}
                  {...editButtonProps}
              ...
              <Button
                variant="contained"
                startIcon={<img src={newPostIcon} alt="New Post Icon" style={{width:"20px"}} />}
                {...newPostButtonProps}
        ...
        <Divider sx={{ width: '100%',mt: 3, mx: 'auto' }} />
      </Paper>
      {/* New Post Dialog */}
      <Dialog
        open={newPostOpen}
